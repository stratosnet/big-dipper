...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals on Stratos Chain | The Big Dipper</title>
                <meta name="description" content="Stratos Chain incorporates on-chain governance. Come to see how on-chain governance can be achieved on The Big Dipper." />
            </Helmet>
            <Row>
